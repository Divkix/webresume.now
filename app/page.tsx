          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="group bg-white rounded-2xl shadow-depth-sm border border-slate-200/60 p-8 hover:shadow-depth-md hover:-translate-y-0.5 transition-all duration-300">
              <div className="flex flex-col items-center text-center gap-4">
                ...
                <div>
                  <div className="text-3xl font-bold text-transparent bg-clip-text bg-linear-to-r from-orange-500 to-amber-600 mb-2">~30s</div>
            ...
            <div className="group bg-white rounded-2xl shadow-depth-sm border border-slate-200/60 p-8 hover:shadow-depth-md hover:-translate-y-0.5 transition-all duration-300">
              <div className="flex flex-col items-center text-center gap-4">
                ...
                <div>
                  <div className="text-2xl font-bold text-transparent bg-clip-text bg-linear-to-r from-indigo-600 to-purple-600 mb-2">AI-Powered</div>
            ...
            <div className="group bg-white rounded-2xl shadow-depth-sm border border-slate-200/60 p-8 hover:shadow-depth-md hover:-translate-y-0.5 transition-all duration-300">
              <div className="flex flex-col items-center text-center gap-4">
                ...
                <div>
                  <div className="text-3xl font-bold text-transparent bg-clip-text bg-linear-to-r from-emerald-500 to-teal-600 mb-2">Free</div>
