...
export function AttributionWidget({ theme }: AttributionWidgetProps) {
  ...
  const themeStyles = {
    ...
    glassmorphic: {
      container: 'bg-slate-900/80 sm:bg-slate-900/80 backdrop-blur-md border border-white/20 text-white/90 hover:text-white',
    ...
    bento_grid: {
      container: 'bg-white/95 sm:bg-white border border-slate-200/60 text-slate-600 hover:text-slate-900',
      accent: 'bg-gradient-to-r from-indigo-600 to-blue-600 bg-clip-text text-transparent',
