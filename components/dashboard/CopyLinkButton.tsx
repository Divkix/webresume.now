    ...
    <button
      ...
      className={cn(
        ...
        copied
          ...
          : "bg-linear-to-r from-coral to-coral hover:from-coral/90 hover:to-coral/90 text-white shadow-depth-sm hover:shadow-depth-md focus:ring-2 focus:ring-coral focus:ring-offset-2",
      )}
    >
      {copied ? (
        <>
